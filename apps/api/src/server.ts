...
function environmentChecks() {
  return {
    ...
    REPORT_CHANNEL: process.env.REPORT_CHANNEL || process.env.REPORT_DELIVERY_CHANNEL || "email",
    MD_REPORT_WHATSAPP_NUMBERS: Boolean(process.env.MD_REPORT_WHATSAPP_NUMBERS),
